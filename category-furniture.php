    ...
    ?>
            <div class="chair-info">
                ...
                <div class="chair-description">
                    ...
                    <a href="category-furniture.php?cart_id=<?php echo $id; ?>&category_id=<?php echo $category_id; ?>" class="add-to-cart js-add-to-cart" onclick="a(event)"><i class="ri-shopping-cart-2-fill"></i>add to cart</a>
                </div>
            </div>
    <?php
        }
